...
int main(void){
	...
	while(1){
		...
		switch(childRequest.readerID){
			...
			case 0:
				write(fd1[1],&products[childRequest.id],sizeof(product));
				break;
			case 1:
				write(fd2[1],&products[childRequest.id],sizeof(product));
				break;
			case 2:
				write(fd3[1],&products[childRequest.id],sizeof(product));
				break;
			case 3:
				write(fd4[1],&products[childRequest.id],sizeof(product));
				break;
			case 4:
				write(fd5[1],&products[childRequest.id],sizeof(product));
				break;
		}
	}
	close(fd[0]);
